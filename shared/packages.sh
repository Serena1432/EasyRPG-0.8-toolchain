...
lib=zlib
ver=1.2.13
ZLIB_URL="https://github.com/madler/zlib/releases/download/v$ver/$lib-$ver.tar.gz"
ZLIB_DIR="$lib-$ver"
...
FREETYPE_URL="https://download-mirror.savannah.gnu.org/releases/$lib/$lib-$ver.tar.gz"
...
lib=libogg
ver=1.3.5
LIBOGG_URL="https://ftp.osuosl.org/pub/xiph/releases/ogg/$lib-$ver.tar.xz"
LIBOGG_DIR="$lib-$ver"
